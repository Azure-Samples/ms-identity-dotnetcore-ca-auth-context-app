...
Function ConfigureApplications
{
   ...
   Write-Host "Creating the AAD application (TodoListClient-authContext-webapp)"
   ...
   $clientAadApplication = New-MgApplication -DisplayName "TodoListClient-authContext-webapp" `
                                                      -Web `
                                                      @{ `
    ...
    Update-MgApplication -ApplicationId $clientAadApplication.Id -IdentifierUris @("https://$tenantName/TodoListClient-authContext-webapp")
    ...
    Write-Host "Done creating the client application (TodoListClient-authContext-webapp)"
    ...
    Add-Content -Value "<tr><td>client</td><td>$currentAppId</td><td><a href='$clientPortalUrl'>TodoListClient-authContext-webapp</a></td></tr>" -Path createdApps.html
