...
#> 
   ...
   $clientAadApplication = New-AzureADApplication -DisplayName "TodoListClient-authContext-webapp" `
                                                  -HomePage "https://localhost:44321/" `
                                                  -LogoutUrl "https://localhost:44321/signout-oidc" `
                                                  -ReplyUrls "https://localhost:44321/", "https://localhost:44321/signin-oidc" `
                                                  -IdentifierUris "https://$tenantName/TodoListClient-authContext-webapp" `
